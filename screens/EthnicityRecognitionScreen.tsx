...
export default function EthnicityRecognitionScreen() {
  ...
  const clarifaiDetectObjectsAsync = async (source: string | undefined) => {
    try {
      ...
      const response = await axios.post(
        "https://api.clarifai.com/v2/users/clarifai/apps/main/models/ethnicity-demographics-recognition/versions/b2897edbda314615856039fb0c489796/outputs",
        {
          inputs: [
            {
              data: {
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.welcomeContainer}>
          <Text style={styles.headerText}>Ethnicity Demographics Recognition</Text>
